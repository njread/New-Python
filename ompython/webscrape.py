...
'''url = "https://john.cs.olemiss.edu/~jones/csci343/pwd/index.php?username=affableOctopus&password=a2345678"
...
for item in items:
    ...
    print(item.find('class', 'line-content').text)'''
import random
